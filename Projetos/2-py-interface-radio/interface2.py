...
def atualizar_resultado():
    ...
    # Obter perferência bdbida "radio"
...
check_saudacao = tk.Checkbutton(janela, text="Usar saudação formal", variable=var_check_saudacao)
...
label_cor = tk.Label(janela, text="Digite sau cor favorita: ")
label_cor.pack(pady=5)
combo_cor = ttk.Combobox(janela, values= ["Vermelho", "Azul", "Verde", "Preto", "Amarelo", "Branco"])
